...
extern "C" EXPORT void getLibInfo(Plugin::LibraryInfo* info)
{
	...
	info->name = "Crossing Detector"; //Name of the Library, used only for information
...
extern "C" EXPORT int getPluginInfo(int index, Plugin::PluginInfo* info)
{
	...
	case 0:
		...
		//For processor
		info->processor.name = "Crossing Detector"; //Processor name shown in the GUI
		...
		info->processor.creator = &(Plugin::createProcessor<CrossingDetector>); //Class factory pointer. Replace "ExampleProcessor" with the name of your class.
		break;
/**
